...
export default function Now() {
  ...
  return (
    ...
    className="max-w-4xl mx-auto px-6 md:px-8 lg:px-1    py-12"
    id="Now"
  >
    {/* Header */}
      ...
      >
        ...
        <ul className="space-y-3 text-gray-300">
          <li className="flex gap-2 text-black">
            ...
            Building responsive UIs with <span className="text-black font-medium">React/Next.js</span>
          </li>
          <li className="flex gap-2 text-black">
            <span className="text-amber-500">↳</span>
            <div>
          ...
          <li className="flex gap-2 text-black">
            <span className="text-amber-500">↳</span>
            Contributing to <span className=" font-medium">design systems</span>
          </li>
        </ul>
      </motion.div>
      ...
      >
        ...
        <ul className="space-y-3  text-black">
          <li className="flex gap-2 text-black">
            ...
            Mastering <span className=" font-medium">JavaScript</span>
          </li>
          <li className="flex gap-2 text-black">
            <span className="text-blue-400">▹</span>
            Experimenting with <span className=" font-medium">Three.js</span>
          </li>
          <li className="flex gap-2 text-black" >
            <span className="text-blue-400">▹</span>
            Optimizing <span className=" font-medium">Lighthouse scores</span>
          </li>
        </ul>
      </motion.div>
      ...
      >
        ...
        <ul className="space-y-3  text-black">
          <li className="flex gap-2">
            ...
            Attending tech events and seminars at my university
          </li>
          <li className="flex gap-2 text-black">
            <span className="text-green-400">✦</span>
